    ...
    <div class="container px-6 py-8 mx-auto">
        <div class="flex flex-col items-center text-center">
            ...
            <!-- <div class="flex flex-wrap justify-center mt-6 -mx-4">
                ...
                <a href="#" class="mx-4 text-sm text-gray-600 transition-colors duration-300 hover:text-tertiary-100 dark:text-gray-300 dark:hover:text-blue-400" aria-label="Reddit"> Contactanos </a>

                <a href="#" class="mx-4 text-sm text-gray-600 transition-colors duration-300 hover:text-tertiary-100 dark:text-gray-300 dark:hover:text-blue-400" aria-label="Reddit"> Terminos </a>
