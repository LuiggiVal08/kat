    ...
    <div x-data="{ show :  true }" class="relative w-fit md:w-full  m-auto max-w-[720px] ">
        ...
        <div
            ...
            <div class="rounded-md max-w-[420px] py-[30px] duration-300 ease w-full bg-white max-sm:w-min min-h-[430px] items-center flex p-6"
                :class="show ? 'hidden' : ''">
                <form id="formRegister" x-data="{ position : 1 }" class="space-y-8 w-full">
                    <h3 class="text-5xl font-sketchup w-full text-text-primary text-center">
                        Registrarse
                    </h3>
                    <div x-show="position == 1" class="space-y-4">
                        ...
                        <label class="relative flex flex-col w-full">
                            <input required class="peer border border-gray-400 dark:border-gray-700 h-[42px] w-full px-4 py-2 rounded-md outline-none text-text-primary" type="text" name="dni" data-valid="dni">
                            <span
                                class="bg-white px-1 absolute  left-3 text-text-secondary text-low transition-all font-light translate-y-[10px]
                                peer-focus:-translate-y-[10px] peer-focus:-translate-x-[5px] peer-focus:scale-90 peer-focus:text-text-primary peer-focus:font-bold
                                peer-valid:-translate-y-[10px] peer-valid:-translate-x-[5px] peer-valid:scale-90 peer-valid:text-text-primary peer-valid:font-bold">
                        ...
                        <label class="relative flex flex-col w-full">
                            <input required class="peer border border-gray-400 dark:border-gray-700 h-[42px] w-full px-4 py-2 rounded-md outline-none text-text-primary" type="text" name="email" data-valid="email">
                            <span
                                class="bg-white px-1 absolute  left-3 text-text-secondary text-low transition-all font-light translate-y-[10px]
                                peer-focus:-translate-y-[10px] peer-focus:-translate-x-[5px] peer-focus:scale-90 peer-focus:text-text-primary peer-focus:font-bold
                                peer-valid:-translate-y-[10px] peer-valid:-translate-x-[5px] peer-valid:scale-90 peer-valid:text-text-primary peer-valid:font-bold">
                    ...
                    <div x-show="position == 2" class="space-y-4">
                        <label class="relative flex flex-col w-full">
                        ...
                        <label class="relative flex flex-col w-full">
                            <input required class="peer border border-gray-400 dark:border-gray-700 h-[42px] w-full px-4 py-2 rounded-md outline-none text-text-primary" type="password" name="confirmPass" data-valid="password">
                            <span
                                class="bg-white px-1 absolute  left-3 text-text-secondary text-low transition-all font-light translate-y-[10px]
                                peer-focus:-translate-y-[10px] peer-focus:-translate-x-[5px] peer-focus:scale-90 peer-focus:text-text-primary peer-focus:font-bold
                                peer-valid:-translate-y-[10px] peer-valid:-translate-x-[5px] peer-valid:scale-90 peer-valid:text-text-primary peer-valid:font-bold">
                    ...
                    <div class="">
                        <button x-show="position == 1" type="button" @click="position = 2" class="w-full group relative flex items-stretch justify-center p-0.5 text-center font-medium transition-[color,background-color,border-color,text-decoration-color,fill,stroke,box-shadow] focus:z-10 focus:outline-none border border-transparent bg-blue-600 text-white focus:ring-4 focus:ring-blue-300 enabled:hover:bg-blue-500 dark:hover:bg-blue-500 dark:focus:ring-blue-800 rounded-lg">
                            <span class="flex items-stretch transition-all duration-200 rounded-md px-4 py-2 text-sm">CONTINUAR</span>
                        </button>
                        <div x-show="position == 2" class="flex-row flex gap-4">
                            <button @click="position = 1" class="text-sm tracking-wide  md:w-[calc(50%-8px)]  duration-200  rounded-md shrink-0
                      flex items-stretch justify-center p-0.5 text-center font-medium transition-[color,background-color,border-color,text-decoration-color,fill,stroke,box-shadow] focus:z-10 focus:outline-none :ring-cyan-700 border border-gray-200 bg-white text-gray-900 focus:text-cyan-700 focus:ring-4 enabled:hover:bg-gray-100 enabled:hover:text-cyan-700 dark:border-gray-600 dark:bg-transparent dark:text-gray-400 dark:enabled:hover:bg-gray-700 dark:enabled:hover:text-white">
                                <span class="flex items-stretch transition-all duration-200 rounded-md px-4 py-2 text-sm">VOLVER</span>
                            </button>
