...
formRegister.querySelector('input[name="dni"]').addEventListener('input', Format.formatInput);
...
formRegister.querySelector('input[name="dni"]').addEventListener('blur', Format.formatInput);
formRegister.querySelector('input[name="username"]').addEventListener('blur', Format.formatInput);
formRegister.querySelector('input[name="email"]').addEventListener('blur', Format.formatInput);
